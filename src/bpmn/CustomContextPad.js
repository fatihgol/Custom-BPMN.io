...
const PALETTE_ICONS = {
  ...
  integrationWaitTask: `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><g transform="translate(2,2)" stroke="#673ab7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" fill="none"><path d="M5 0h10 M5 16h10 M5 0l5 8-5 8 M15 0l-5 8 5 8"/><path d="M 19,8 H 12"/><path d="M 14,6 L 12,8 L 14,10"/></g></svg>`,
